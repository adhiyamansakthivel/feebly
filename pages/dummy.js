    ...
    return (
        <>
            <div className="absolute bg-white w-full h-full">
                                        ...
                                        <li className="text-gray-700 pt-8">
                                            <div className="flex items-center">
                                                <div className="flex items-center">
                                                    ...
                                                    <p className="text-gray-700 ml-3 text-lg" onClick={() => setTechnology(!technology)}>Products</p>
                                                </div>
                                                <div onClick={() => setProduct(!technology)}>
                                                    {technology ? (
                                                        <div className=" ml-4">
                ...
                {/* Mobile */}
                <nav className="w-full mx-auto items-center bg-gray-800 shadow relative z-20">
                    <div className="justify-between container px-6 h-16 flex items-center lg:items-stretch mx-auto">
                        <div className="flex items-center">
                            <div className="mr-10 flex items-center">
                                ...
                                <h3 className="text-base text-white font-bold tracking-normal leading-tight ml-3 hidden lg:block">feeblytech</h3>
                            </div>
                            <ul className="pr-32 xl:flex hidden items-center h-full">
                                <li className="hover:text-white cursor-pointer h-full flex items-center font-bold text-sm text-white tracking-normal">Home</li>
                                ...
                                <li className="hover:text-indigo-700 cursor-pointer h-full flex items-center font-bold text-sm text-white mr-10 tracking-normal">Gadget News</li>
                                <li className="hover:text-white cursor-pointer h-full flex items-center font-bold text-sm text-white mx-10 tracking-normal relative" onClick={() => setEntertainment(!entertainment)}>
                                    {entertainment ? (
                                        <ul className="bg-gray-800 shadow rounded py-1 w-32 left-0 mt-16 -ml-4 absolute  top-0">
                                            <li className="cursor-pointer text-white text-sm leading-3 tracking-normal py-3 hover:bg-white  hover:text-purple-600 px-3 font-bold">Landing Pages</li>
                                            <li className="cursor-pointer text-white text-sm leading-3 tracking-normal py-3 hover:bg-white  hover:text-gray-600 px-3 font-bold">Templates</li>
                                            <li className="cursor-pointer text-white text-sm leading-3 tracking-normal py-3 hover:bg-white  hover:text-gray-600 px-3 font-bold">Components</li>
                                        </ul>
                                    ) : (
                                ...
                                <li className="hover:text-indigo-700 cursor-pointer h-full flex items-center text-sm font-bold text-white mr-10 tracking-normal">Gaming</li>
